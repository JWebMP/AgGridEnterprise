...
- Repository URL / local path: https://github.com/JWebMP/AgGridEnterprise.git
- Org and project name: JWebMP / Ag Grid (Angular Data Grid) Enterprise 
- Short description: The JWebMP Plugin and extension for the Ag Grid to enable Enterprise Functionality
